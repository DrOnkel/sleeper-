...
TIMSK2=0x02;
   ...
   Serial.begin(9600);  
   Serial.print ("Blut Tooth Crane  9600 ");
}
...
CourseDiff=Course-AngleCourse;  // here we calculate the error of course

// here we select the close angle of rotation to hold the course
if(CourseDiff > 1800)
...
if(Speed>50)   // if speed is extremely low - we calculate no integral component of correction
  {
I=I+Ai*CourseDiff;
if(I<-30)
I=-30;
...
Rotate= Ap*CourseDiff+I;  // Scale the integral error signal
...
// Calculate the Turn as it was from BT Remote
Turn =88+int(Rotate);
 //  Serial.write(0xAA);
}
else
{
// if no course stabilisation let make integral part of error 0
I=0;
